...
import com.corneliadavis.cloudnative.connectionsposts.projection.Connection;
import com.corneliadavis.cloudnative.connectionsposts.projection.ConnectionRepository;
import com.corneliadavis.cloudnative.connectionsposts.projection.Post;
import com.corneliadavis.cloudnative.connectionsposts.projection.PostRepository;
import com.corneliadavis.cloudnative.connectionsposts.projection.User;
...
public class EventHandler {
    ...
    /**
     * Handles changes to connections – who follows who.
     * It is 'created' and 'deleted' events.
     *
     * @param connectionEvent The event in the 'connection' queue to handle.
     */
    ...
    /**
     * Handles changes to posts – that is, new posts.
     *
     * @param postEvent The event in the 'connection' queue to handle.
     */
